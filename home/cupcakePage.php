...
//echo $_SESSION['qry'];
   ...
   $_SESSION['iAmAt']="cupcakePage.php";
        ...
        <div style="margin-left:2px;">
         <div class="accordion" id="accordion">
            ...
            <div class="card">
               ...
               <div class="collapse show" id="cupcakeOpts" aria-labelledby="headingThree" data-parent="#accordion">
                  <div class="card-body">
     ...
     $(document).ready(function(){
        if (window.performance) {
           ...
           if (performance.navigation.type == 1) {
             ...
             <?php $_SESSION['qry']="SELECT * FROM products WHERE prod_category='cupcake'";?>
             //alert( "when u visit the page first");
             window.location.reload();
             $('input:checkbox').prop('checked',false);
             $('#allCup').prop('checked',true);
             var page="cupcake";
             $.ajax({
                type:'post',
