<?php
   ...
   if(isset($_SESSION["username"]))
   {
      ...
      //Isprod already added to wishlist?
      $q="SELECT ProductID from wish WHERE CustomerID='$cust'";
      ...
      if(in_array($id,$prod)==FALSE)
      {
         ...
         $query2="INSERT INTO wish(CustomerID,ProductID,ProductPrice,Quantity,vegan,FinalPrice)
          VALUES('$cust','$id','$unitPrice','1','$vegan','$total')";
