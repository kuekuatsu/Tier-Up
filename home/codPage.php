...
date_default_timezone_set('Asia/Kolkata');
   ...
   else
   {
      ...
      $c=new mysqli($h,$u,$p,$data) or die("fail");
?>
<ul class="nav justify-content-end">
   ...
   <li class="nav-item">
      <a class="nav-link active">Order Placed
      <hr style="background-color:blue;height:0.5px;"></a>
   </li>
</ul>
      <form>
         <br><br>
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-md-10" style="border:1px solid black;text-align:center;border-radius:5px;">
                  <br>
                  <h5 class="display-4">
                     <input type="hidden" id="hid" value="<?php echo $cost ?>">
                     &#x20B9 <?php echo $cost ?> is the amount charged for this order
                  </h5>
                  ...
                  <?php
                     $q2="SELECT * FROM orderlist WHERE cid='$cid'";
      ...
      if (performance.navigation.type == 1) {
        //alert( "on page reload" );
         ...
         $(document).ready(function(){
            ...
            $.ajax({
               type:'post',
               url:'phpProcess/cod.php',
               data:{'type':type,'cost':cost},
