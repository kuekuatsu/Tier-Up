...
<link href="https://fonts.googleapis.com/css?family=Raleway:600|Indie+Flower|Allura|Berkshire+Swash|Comfortaa|Courgette|Lobster+Two|Merienda|Playball|Satisfy|Sofia|Englebert|Open+Sans" rel="stylesheet">
        ...
        <div style="margin-left:2px;">
         <div class="accordion" id="accordion">
            <div class="card">
               ...
               <div id="cakeOpts" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                  <div class="card-body">
            ...
            <div class="card">
               ...
               <div class="collapse" id="breadOpts" aria-labelledby="headingFour" data-parent="#accordion">
                  <div class="card-body">
             ...
             <table cellpadding="5px">
                <tr>
                   ...
                   <td>
                     ...
                     <label for="fil"><a id="filter" style="font-size:35px;transition:0.3s;font-weight:bold;">&#x21C5</a><a id="close" style="font-size:0px;font-weight:bold;transition:0.3s;z-index">&#x2715</a></label>
                   </td>
                </tr>
             </table>
           </div>
     ...
     $(document).ready(function(){
        if (window.performance) {
           ...
           if (performance.navigation.type == 1) {
             ...
             <?php $_SESSION['qry']="SELECT * FROM products WHERE prod_category='cake'";?>
             //alert( "when u visit the page first");
             window.location.reload();
             $('input:checkbox').prop('checked',false);
             $('#allCake').prop('checked',true);
             var page="cake";
             $.ajax({
                type:'post',
