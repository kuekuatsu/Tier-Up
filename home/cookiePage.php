        ...
        <div style="margin-left:2px;">
         <div class="accordion" id="accordion">
            ...
            <div class="card">
               ...
               <div class="collapse show" id="cookieOpts" aria-labelledby="headingTwo" data-parent="#accordion">
                  <div class="card-body">
     ...
     $(document).ready(function(){
        if (window.performance) {
           ...
           if (performance.navigation.type == 1) {
             ...
             <?php $_SESSION['qry']="SELECT * FROM products WHERE prod_category='cookie'";?>
             //alert( "when u visit the page first");
             window.location.reload();
             $('input:checkbox').prop('checked',false);
             $('#allCookie').prop('checked',true);
             var page="cookie";
             $.ajax({
                type:'post',
